      ...
      >
        ...
        <div class="backdrop-blur-[2px] text-white text-start md:text-center tracking-wider font-lato flex flex-col justify-center items-center gap-y-8 text-xl md:text-3xl px-4 md:px-0 w-full max-w-[900px]">
          <p class="text-pretty">
            ...
            <T>.</T> <T>A</T>demás de crear aplicaciones web con React
            <T>.</T>js y Next<T>.</T>js<T>, </T>
          ...
          <p class="text-pretty">
            ...
            través del <T>testing</T> y siempre busco contribuir al desarrollo
            de productos innovadores<T>.</T>
          </p>

          <p class="text-pretty ">
            <T>Abierto</T> a nuevos desafíos<T>,</T> estoy preparado para
            aportar con código <T>legible</T> y <T>buenas prácticas</T>
            <T>.</T>
          </p>
